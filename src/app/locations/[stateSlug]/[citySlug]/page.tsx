          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="text-center space-y-6 animate-fade-in">
              ...
              <h1 className="text-5xl md:text-8xl font-black text-primary uppercase tracking-tighter leading-tight">
                {cityName}, <span className="text-accent">{stateName}</span>
              </h1>
              <p className="text-2xl font-bold text-primary/80 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-16">
              <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center space-y-6 group hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">Lock in your guaranteed moving date with our professional {cityName} crew.</p>
                </div>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center space-y-6 group hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">Get a detailed, binding estimate for your {cityName} relocation in minutes.</p>
                </div>
