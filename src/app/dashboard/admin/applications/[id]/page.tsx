...
function ApplicationReviewContent({ id }: { id: string }) {
  ...
  if (isLoading) return <div className="p-20 text-center font-bold text-primary animate-pulse uppercase tracking-widest">Loading Application...</div>;
  if (!application) return <div className="p-20 text-center font-bold text-red-500 uppercase tracking-widest">Application not found.</div>;
