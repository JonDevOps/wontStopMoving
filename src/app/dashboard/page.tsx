        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card className="border-none shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link href="/dashboard/moves" className="text-xs font-bold text-accent hover:underline">See All</Link>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-none shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link href="/dashboard/quotes" className="text-xs font-bold text-accent hover:underline">See All</Link>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {quotesLoading ? (
