...
const signupSchema = z.object({
  ...
  accountType: z.enum(['customer', 'provider']).default('provider'),
});
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden px-4 pt-20">
        ...
        <Card className="w-full max-w-md border-none shadow-2xl relative z-10 bg-white my-12">
          <CardHeader className="space-y-4 text-center pt-10">
            ...
            <div>
              <h1 className="text-3xl font-black text-primary uppercase tracking-tighter">Become a <span className="text-accent">Provider</span></h1>
              <p className="text-muted-foreground text-sm">Join the Network and Earn Daily</p>
            </div>
          </CardHeader>
